import "./style.css";
import { renderNav, renderTodo, checkFilter } from "./renderScreen";
  ...
  const generateDemoTodoData = () => {
    todoArray.push(
      createTodo(
        "0",
        "Feed the dog",
        "1 cup full of dry food. Dont forget to give him water !",
        "2025-08-09",
        "Pets",
        "High",
      ),
    ...
    todoArray.push(
      createTodo(
        ...
        "Change cat water fountain filter. Order more if we have run out",
        "2026-08-09",
        "Pets",
        "Low",
      ),
    ...
    todoArray.push(
      createTodo(
        "2",
        "Kitchen touchups",
        "Paint the white kitchen touchups before the floor gets fitted. Clean up the mess after.",
        "2025-08-09",
        "Home",
        "Medium",
      ),
    ...
    todoArray.push(
      createTodo("3", "Eggs", "Buy eggs", "2024-08-09", "Shopping", "Low"),
    );
    todoArray.push(
      createTodo("4", "Bread", "Buy bread", "2024-08-09", "Shopping", "High"),
    );
    todoArray.push(
      createTodo(
        "5",
        "Orange Juice",
        "Buy orange juice. (Not from concentrate)",
        "2024-08-09",
        "Shopping",
        "Medium",
      ),
    ...
    todoArray.push(
      createTodo(
        "6",
        "Learn Webkit",
        "Get a good working understanding of using webkit for building websites and modules",
        "2024-08-09",
        "Coding",
        "High",
        true,
    ...
    todoArray.push(
      createTodo(
        "7",
        "Tidy up code",
        "Go back over this code and try to tidy it up. Try to group more processes so the functions arent so bulky",
        "2024-08-18",
        "Coding",
        "Medium",
      ),
